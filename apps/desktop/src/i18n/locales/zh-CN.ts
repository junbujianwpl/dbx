...
export default withEnglishFallback({
  ...
  settings: {
    ...
    sidebarObjectInfoModeDescription: "选择在名称后显示注释、对象大小或不显示。注释与表大小互斥；数据库总大小会在侧边栏自动显示（MySQL、PostgreSQL、GaussDB、KWDB、openGauss），表大小支持 MySQL、PostgreSQL、GaussDB、Kingbase、GBase 8a、SQL Server、Oracle、达梦和 ClickHouse。",
