...
export default withEnglishFallback({
  ...
  settings: {
    ...
    sidebarObjectInfoModeDescription: "選擇在名稱後顯示註解、物件大小或不顯示。註解與資料表大小互斥；資料庫總大小會在側邊欄自動顯示（MySQL、PostgreSQL、GaussDB、KWDB、openGauss），資料表大小支援 MySQL、PostgreSQL、GaussDB、Kingbase、GBase 8a、SQL Server、Oracle、達夢和 ClickHouse。",
